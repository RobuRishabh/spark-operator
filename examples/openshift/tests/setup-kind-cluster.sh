...
echo "  1. Run Go e2e tests:  SPARK_OPERATOR_IMAGE=<image> make e2e-kustomize-test"
echo "  2. Run docling test:  make e2e-docling-test  (requires preloaded docling image)"
